...
#define dataPinTgl  4
#define clockPinTgl  5
//Tabel Mulai Digit 0 displau 1,77 inch
//byte segCharTgl[] = {0xFA,0x18,0xEC,0xBC,0x1E,0xB6,0xF7,0x98,0xFF,0xBF,0x00,0xFF};
//byte segCharTgl[] = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};
//byte segCharTgl[] = {0xFE,0xFE,0xFE,0xFe,0xFe,0xFe,0xFE,0xFE,0xFE,0xFE,0xFE,0xFE};
//byte segCharTgl[] = {0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD,0xFD};
byte segCharTgl[] = {0xFB, 0x12, 0x67, 0x37, 0x1E, 0x3D, 0x7D, 0x13, 0xFF, 0x3F, 0x00, 0xFF};
